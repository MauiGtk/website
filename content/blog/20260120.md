...
Unique selling point of .NET MAUI compared to other cross-platform tools such as PhoneGap, Uno, Flutter, Avalanche, Electron, ReactNative are that native controls of the respective platform are used by MAUI and not self-drawn or generated using a browser engine that look the same everywhere.
...
- Qt is based on C++ along with a special precompiler but we more like the modern C# language MAUI is written in and there is good support for Gtk with GtkSharp and gir.core.
